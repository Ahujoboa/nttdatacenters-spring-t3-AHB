package com.nttdata.nttdatacentersspringt3AHB.services;
...
import com.nttdata.nttdatacentersspringt3AHB.repository.ClientRepository;
import com.nttdata.nttdatacentersspringt3AHB.repository.Cliente;

@Service
public class ClientManagementServiceImpl implements ClientRepository {
	...
	public List<Cliente> buscarPorNombreYApellido(String nombre, String apellido) {
		//TODO: recorrer la lista de clientes y devolver una nueva lista con los clientes que tengan los nombres y apellidos que entran por parámetros.
		for(Cliente cliente: )
	}
